...
pub fn process_gz_files(fname: String) -> String {
    let gzlist = ["gz", "GZ"];
    ...
    if fname.contains("python3-openid") {
        ...
        if path.is_file() {
            ...
            if gzlist.contains(&ext) {
                ...
                let outdir = "/media/pipi/0123-4567/Images/GZ1_Unzip/".to_string() + &fdigest;
...
pub fn process_zip_files(fname: String) {
    let ziplist = ["zip", "ZIP"];
...
pub fn process_bz2_files(fname: String) {
    let bz2list = ["bz2", "BZ2"];
